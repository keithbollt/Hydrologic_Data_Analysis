...
<add notes here> Carrots make a note not appear in the final document 
USGS stream flow 
...
Whether there are trends in flow seasonally, yearly, or after a storm; or to just visualize what the flow is opr compare flows of different streams.
