...
> Variable 3: Chlorophyl A

> Variable 4: LULC 500m cafo

> Variable 5: Seiki Depth
...
```{r}
# Wrangle data here.
#You would get the info from the LAGOS dataframes from lesson 9. Look at the second chunk from lesson 9 to make the dataframes. Then, you leftjoin all the dataframes you created by lagos lakeid. Then you select the columns you want.
LAGOSlocus <- LAGOSdata$locus
LAGOSstate <- LAGOSdata$state
LAGOSnutrient <- LAGOSdata$epi_nutr
LAGOSlulc <- LAGOSdata$buffer500m.lulc
LAGOSseiki <- LAGOSdata$hu8.chag
...
LAGOSseiki$lagoslakeid <- as.factor(LAGOSseiki$lagoslakeid)
...
LAGOSTPandN <- left_join(LAGOSloc.nut, LAGOSlulc, by = "lagoslakeid")

LAGOS.processed <- left_join(LAGOSTPandN, LAGOSseiki, by = "lagoslakeid")
