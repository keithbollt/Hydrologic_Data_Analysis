...
dim(NTLdata)
NTLdata <- NTLdata %>%       # this is how you use piping
...
TempprofileMay2016 <- 
  ...
  scale_y_reverse(breaks = c(0, 2, 4, 6, 8, 10, 12)) +         # this is how you make a graph look like a lake profile
...
Epilimnion: Well mixed, warm surface layer of a lake
Metalimnion: The thermocline; rapid change in physical water conditions
Hypolimnion: The cold, bottom layer of a lake that is separated from the surface layer by the metalimnion
