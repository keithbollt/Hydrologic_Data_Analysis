...
> For the hysteresis loops, we do not care about gaps in the data, because we are looking at high frequency data in response to individual storms. For baseflow separation analysis, we include in our code a timestep process that connects gaps in our data.
...
Kansasbaseflow <- EcoHydRology::BaseflowSeparation(
  Kansas.DO.processed$Discharge_m3s, 
