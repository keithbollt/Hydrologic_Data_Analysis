...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Year =} \KeywordTok{year}\NormalTok{(Date),}
         \DataTypeTok{Day.of.Year =} \KeywordTok{yday}\NormalTok{(Date))}

\NormalTok{MysterySiteDischarge.Pattern <-}
\StringTok{  }\NormalTok{MysterySiteDischarge }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Day.of.Year)}\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{FirstQuartile.Discharge =} \KeywordTok{quantile}\NormalTok{(Discharge, }\DataTypeTok{probs=}\NormalTok{(}\FloatTok{0.25}\NormalTok{)),}
    \DataTypeTok{Median.Discharge =} \KeywordTok{quantile}\NormalTok{(Discharge, }\DataTypeTok{probs=}\NormalTok{(}\FloatTok{0.50}\NormalTok{)),}
    \DataTypeTok{ThirdQuartile.Discharge =} \KeywordTok{quantile}\NormalTok{(Discharge, }\DataTypeTok{probs=}\NormalTok{(}\FloatTok{0.75}\NormalTok{))) }

\NormalTok{Pattern.plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(MysterySiteDischarge.Pattern)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Day.of.Year, }\DataTypeTok{y =}\NormalTok{ FirstQuartile.Discharge), }\DataTypeTok{color =} \StringTok{"gray"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Day.of.Year, }\DataTypeTok{y =}\NormalTok{ Median.Discharge))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Day.of.Year, }\DataTypeTok{y =}\NormalTok{ ThirdQuartile.Discharge), }\DataTypeTok{color =} \StringTok{"gray"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Day of Year"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Discharge (cfs)"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
  
\KeywordTok{print}\NormalTok{(Pattern.plot)  }
\end{Highlighting}
\end{Shaded}

\includegraphics{A03_RiversPhysical_files/figure-latex/message FALSE-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Creating the dataframes}
...
\KeywordTok{names}\NormalTok{(MysterySite.Annual}\FloatTok{.30}\NormalTok{yr)[}\DecValTok{2}\OperatorTok{:}\DecValTok{5}\NormalTok{] <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"PeakDischarge30"}\NormalTok{, }\StringTok{"Rank30"}\NormalTok{, }\StringTok{"RecurrenceInterval30"}\NormalTok{,}
                                         \StringTok{"Probability30"}\NormalTok{)}

\NormalTok{MysterySitejoin <-}\StringTok{ }\KeywordTok{full_join}\NormalTok{(MysterySite.Annual}\FloatTok{.30}\NormalTok{yr, MysterySite.Annual.Full, }\DataTypeTok{by =} \StringTok{"Year"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#30 year data modelling a 100 year flood}
\NormalTok{MysterySite30.RImodel <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ MysterySitejoin, PeakDischarge30 }\OperatorTok{~}\StringTok{ }\KeywordTok{log}\NormalTok{(RecurrenceInterval30))  }
\KeywordTok{summary}\NormalTok{(MysterySite30.RImodel)  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{MysterySite30.RImodel}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{1}\NormalTok{] }\OperatorTok{+}\StringTok{ }\NormalTok{MysterySite30.RImodel}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\KeywordTok{log}\NormalTok{(}\DecValTok{100}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#5758.6 cfs}

\CommentTok{#Full Dataset modelling a 100 year flood}
\NormalTok{MysterySiteFull.RImodel <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ MysterySitejoin, PeakDischarge }\OperatorTok{~}\StringTok{ }\KeywordTok{log}\NormalTok{(RecurrenceInterval))  }
\KeywordTok{summary}\NormalTok{(MysterySiteFull.RImodel)  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{MysterySiteFull.RImodel}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{1}\NormalTok{] }\OperatorTok{+}\StringTok{ }\NormalTok{MysterySiteFull.RImodel}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\KeywordTok{log}\NormalTok{(}\DecValTok{100}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
